...
var jQuery = (function () {
 ...
 typeof length === "number" && ((length > 0 && elems[0] && elems[length - 1]) || length === 0 || jQuery.isArray(elems)) ;
  ...
  add: function (elem, types, handler, data, selector) {
    ...
    if (!eventHandle) {
      elemData.handle = eventHandle = function (e) {
        ...
        typeof jQuery !== "undefined" && (!e || jQuery.event.triggered !== e.type) ?
...
jQuery.buildFragment = function (args, nodes, scripts) {
 ...
 typeof first === "string" && first.length < 512 && doc === document &&
...
jQuery.extend({
 ...
 typeof speed === "object" ? jQuery.extend({}, speed) : {
